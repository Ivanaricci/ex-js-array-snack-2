...
const areAuthorsAdult = authors.every(m => {
    return m > 18
})

console.log(`Gli autori sono tutti maggiorenni: ${areAuthorsAdult}`)
...
console.log(`Età media autori: ${etàMedia}`)
